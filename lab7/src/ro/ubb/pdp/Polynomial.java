...
public class Polynomial {
    ...
    public Polynomial(int[] arrayOfCoefficients) {
        coefficients = new ArrayList<>(arrayOfCoefficients.length);
        //Generate the rest of the coefficients
        for (int arrayOfCoefficient : arrayOfCoefficients) {
            coefficients.add(arrayOfCoefficient);
        }
    ...
    public void addZeroesToEnd(int count)
    {
