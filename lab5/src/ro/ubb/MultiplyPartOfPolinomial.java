...
public class MultiplyPartOfPolinomial implements Runnable {
    private int start;
    private int end;
    private Polynomial p1, p2, result;

    public MultiplyPartOfPolinomial(int start, int end, Polynomial p1, Polynomial p2, Polynomial result) {
        this.start = start;
        this.end = end;
        this.p1 = p1;
        this.p2 = p2;
